<template>
  <div class="skill-item-passive w-[56px] h-[56px] z-0">
    ...
    <!-- Rank (shown on hover) -->
    <div
      class="skill-item-passive__rank pointer-events-none absolute z-30 text-white translate-x-[28px] translate-y-11 font-semibold bg-gradient-to-l from-black/75 text-sm pr-[2px] select-none transition-opacity"
      :class="rankClass"
    >
      {{ rank }}/{{ rankMax }}
    </div>
